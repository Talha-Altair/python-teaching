...
alias donut=conda
alias ealias='gedit ~/.zshrc'
alias egrep='egrep --color=auto --exclude-dir={.bzr,CVS,.git,.hg,.svn,.idea,.tox}'
alias fgrep='fgrep --color=auto --exclude-dir={.bzr,CVS,.git,.hg,.svn,.idea,.tox}'
alias fpr='conda activate fpr'
alias g=git
alias ga='git add'
...
alias gcom='gad && gimmit'
alias gcon='git remote -v'
...
alias gush=/home/talha/gitmagic/gu.sh
...
alias lsa='ls -lah'
alias md='mkdir -p'
alias mwd='cd ; cd tact/'
alias ohmyzsh='mate ~/.oh-my-zsh'
alias pip=pip3
alias pipi='pip install -r requirements.txt'
alias py=python3
alias rd=rmdir
alias resh=/home/talha/gitmagic/re.sh
alias rh=resh
alias seri='cd ; cd tact/serkinti-ui/'
alias soume='source ~/.~/.bashrc'
alias sshb='ssh-add -K ~/.ssh/id_rsa'
